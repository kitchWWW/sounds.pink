...
HTML_FETCH_STATUS_GOOD = 'good'
HTML_FETCH_STATUS_BAD = 'nope'
...
def fetchJsonFromWeb():
	...
	try:
		url = 'http://localhost:3000/otherProjects/positions/position_{0}.json'.format(CUSTOM_CODE)
